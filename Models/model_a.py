# -*- coding: utf-8 -*-
"""Antimicrobial_New_Model_a.ipynb
...
for train_index,test_index in kf.split(X1,Y):
    ...
    result.append(model.fit(x=[X1[train_index,:,:],X2[train_index,:,:]],y=Y[train_index],validation_data=([X1[test_index,:,:],X2[test_index,:,0:]],Y[test_index]), epochs=epoch_value, batch_size=15,callbacks=callbacks_list))
